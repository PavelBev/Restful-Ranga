...
* The original package name 'ru.in28minutes.microservices.currency-exchange-service' is invalid and this project uses 'ru.in28minutes.microservices.currency_exchange_service' instead.
